...
export class seedGenerator {
    ...
    constructor()
    {
        ...
        this._addresses = this._seeds._addresses.map( a => { return {
        ...
        this._quotes = this._seeds._quotes.map( q => { return {
            _quote: q.jsonQuote,
            _author: q.jsonAuthor
        }});


        this._latin = this._seeds._latin.map( q => { return {
    ...
    get allQuotes() {
        //deep copy of the []
        return this._quotes.map( q => { return {
        quote: q._quote,
        author: q._author
        }});
    }
    ...
    get allLatin() {
        //deep copy of the []
        return this._latin.map( l => { return {
